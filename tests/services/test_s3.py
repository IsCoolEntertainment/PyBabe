...
class TestS3(TestCase):
    ...
    def test_s3_glob(self):
        ...
        a = Babe().pull(string=s,
                        format='csv',
                        name='Test')
        a.push(filename='test_glob_4.csv',
               bucket='florian-test',
               protocol="s3")
        b = Babe().pull(filename='test_glob_?.csv',
                        name='Test',
                        bucket='florian-test',
                        protocol="s3")
        self.assertEquals(b.to_string(), s)
    ...
    def test_s3_glob2(self):
        ...
        a = Babe().pull(string=s,
                        format='csv',
                        name='Test')
        a.push(filename='foofoobar/test_glob_4.csv',
               bucket='florian-test',
               protocol="s3")
        b = Babe().pull(filename='foofoobar/test_glob_?.csv',
                        name='Test',
                        bucket='florian-test',
                        protocol="s3")
        self.assertEquals(b.to_string(), s)
